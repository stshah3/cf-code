#!/usr/bin/env python
#This is a simple program which logs data to a file directly from Crazyflie instruments, specifically Battery Voltage, Stabilizer, Barometer, and Accelerometer.
...
class Main:
    ...
    def __init__(self):
        ...
        self.crazyflie.open_link("radio://0/2/250K")
    ...
    def print_pm_data(self, ident, data, logconfig):
        logging.info("Id={0}, Battery Voltage(V): vbat={1:.4f}".format(ident, data["pm.vbat"]))
